...
namespace GeoPedia.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Population,Mayor,Country_Code,Established")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Population,Mayor,Country_Code,Established")] City city)
        {
            if (ModelState.IsValid)
            {
